...
// Tranforma o MainActivity em uma interface do OnClickListener
    ...
    public void onClick(View view) {
        ...
        if (view.getId() == R.id.button_calculate) {
            ...
            if ("".equals(value)) {
                ...
                // Converte valores
                this.mViewHolder.textDollar.setText(String.format("$ %.2f", real / 5.80));
                this.mViewHolder.textEuro.setText(String.format("€ %.2f", real / 6.27));
            }
        }
    }
